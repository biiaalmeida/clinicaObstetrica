...
public class PacienteDAO {
    ...
    public boolean editarPaciente(PacienteModel paciente) {
        ...
        String sqlPaciente = "UPDATE paciente SET idade = ?, telefoneContato = ?, endereco = ?,tipoSanguineo = ?, tipoPlanodeSaude = ?, alergias = ?, numGestacoesAnteriores = ?, vacinas = ?, peso = ?, condicoesPreEx = ? WHERE cpfPaciente = ?";
